...
export default function IntroCard() {
  ...
  return(
    <Box display='flex' dir="row" justifyContent='space-evenly' width='100vw' height='100%'>
      <Image src="images/me-main.jpg" height='100%' width='50%' fit='cover' />
      <Flex direction='column' justifyContent='center' height='100%' width='50vw' p='3' overflowY='scroll'>
        <Heading>
